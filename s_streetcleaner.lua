...
function startCleaningMission(thePlayer)
	if (isElement(thePlayer)) then
		...
		exports.nrpSavunma4:changeProtectedElementDataEx(vehicle, "fuel", 100)
		exports.nrpSavunma4:changeProtectedElementDataEx(vehicle, "owner", -2, false)
		exports.nrpSavunma4:changeProtectedElementDataEx(vehicle, "faction", -1, false)
		exports.nrpSavunma4:changeProtectedElementDataEx(vehicle, "dbid", 999999, false)
		exports.nrpSavunma4:changeProtectedElementDataEx(vehicle, "oldx", 1503.5179443359, false)
		exports.nrpSavunma4:changeProtectedElementDataEx(vehicle, "oldy", 369.0305175781, false)
		exports.nrpSavunma4:changeProtectedElementDataEx(vehicle, "oldz", 10.8203125, false)
		exports.nrpSavunma4:changeProtectedElementDataEx(vehicle, "engine", 1, false)
		removePedFromVehicle(thePlayer)
		warpPedIntoVehicle(thePlayer, vehicle)
		
		exports.nrpSavunma4:changeProtectedElementDataEx(thePlayer, "cleaner.marker", "1")
		exports.nrpSavunma4:changeProtectedElementDataEx(thePlayer, "cleaner.vehicle", vehicle)
		...
		if tonumber(int) == 1 then
			...
			exports.nrpSavunma4:changeProtectedElementDataEx(thePlayer, "cleaner.checkmarkers", "25")
			exports.nrpSavunma4:changeProtectedElementDataEx(thePlayer, "cleaner.t", "1")
		elseif tonumber(int) == 2 then
			x1 = CheckpointStyle_2[1].x_point
			y1 = CheckpointStyle_2[1].y_point
			z1 = CheckpointStyle_2[1].z_point
			exports.nrpSavunma4:changeProtectedElementDataEx(thePlayer, "cleaner.checkmarkers", "17")
			exports.nrpSavunma4:changeProtectedElementDataEx(thePlayer, "cleaner.t", "2")
		elseif tonumber(int) == 3 then
			x1 = CheckpointStyle_3[1].x_point
			y1 = CheckpointStyle_3[1].y_point
			z1 = CheckpointStyle_3[1].z_point
			exports.nrpSavunma4:changeProtectedElementDataEx(thePlayer, "cleaner.checkmarkers", "17")
			exports.nrpSavunma4:changeProtectedElementDataEx(thePlayer, "cleaner.t", "3")
		end																				--- <<<<<<<<<<<<<<<<<<<<<<<<<<<<<
		...
		exports.nrpSavunma4:changeProtectedElementDataEx(colsphere, "attatched", marker2)
		
		addEventHandler("onColShapeHit", colsphere, UpdateCheckpoints)
		
		outputChatBox("Drive around İstanbul on your cleaning path, sweeping the streets. ((Drive through the checkpoints))", thePlayer, 255, 194, 14)
	end
	...
	if ( isPedInVehicle ( thePlayer ) ) then
		...
		if tonumber(vehid) == 574 then
			...
			if tonumber(max_number) == tonumber(m_number) then
				...
				exports.nrpSavunma4:changeProtectedElementDataEx(colsphere, "attatched", marker3)
				
				addEventHandler("onColShapeHit", colsphere, FinalCheckpoints)
			else
				local newnumber = m_number+1
				exports.nrpSavunma4:changeProtectedElementDataEx(thePlayer, "cleaner.marker", newnumber)
...
function FinalCheckpoints( thePlayer )
	if ( isPedInVehicle ( thePlayer ) ) then
		...
		if tonumber(vehid) == 574 then
			...
			exports.nrpSavunma4:changeProtectedElementDataEx(colsphere, "attatched", marker4)
	...
	if (isElement(thePlayer)) then
		if ( isPedInVehicle ( thePlayer ) ) then
			...
			if tonumber(vehid) == 574 then
				...
				exports.nrpSavunma4:changeProtectedElementDataEx(vehicle, "fuel")
				exports.nrpSavunma4:changeProtectedElementDataEx(vehicle, "dbid")
				
				if (isElement(vehicle)) then
					destroyElement(vehicle)
					vehicle = nil
					exports.nrpSavunma4:changeProtectedElementDataEx(thePlayer, "cleaner.vehicle")
					
					outputChatBox("You have completed your task, well done.", thePlayer, 255, 194, 14)
					outputChatBox("You received: 300TL", thePlayer, 255, 194, 14)
...
function quit()
	...
	exports.nrpSavunma4:changeProtectedElementDataEx(source, "cleaner.vehicle")
end
