...
function ejectPlayerFromBus()
	exports.nrpSavunma4:changeProtectedElementDataEx(source, "realinvehicle", 0, false)
...
function createBusBlips( )
	for routeID, route in ipairs( g_bus_routes ) do
		...
		for pointID, point in ipairs( route.points ) do
			...
			--	blips[routeID][stop] = createBlip( point[1], point[2], point[3], 121, 1, 0, 63, 63, 127, -5, 65 )
